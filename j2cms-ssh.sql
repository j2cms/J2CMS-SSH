...
--
-- Create schema `j2cms-ssh`
--

CREATE DATABASE IF NOT EXISTS `j2cms-ssh`;
USE `j2cms-ssh`;

--
-- Definition of table `j2_article`
--

DROP TABLE IF EXISTS `j2_article`;
CREATE TABLE `j2_article` (
...
--
-- Dumping data for table `j2_article`
--

/*!40000 ALTER TABLE `j2_article` DISABLE KEYS */;
INSERT INTO `j2_article` (`id`,`author`,`check_date`,`check_state`,`comment_count`,`comment_state`,`content`,`content_img`,`disable_date`,`origin`,`recommend_level`,`related_id`,`release_date`,`release_sys_date`,`summary`,`tags`,`title`,`title_img`,`visit_total`,`channel_id`,`group_id`,`user_id`,`sys_date`) VALUES 
 (1,'管理员',NULL,2,0,'Y','<p>功能更新：</p>\r\n<p>&nbsp;</p>\r\n<p>1.实现用户组权限管理；</p>\r\n<p>&nbsp;</p>\r\n<p>2.优化内容管理与用户管理模块的查询功能；</p>\r\n<p>&nbsp;</p>\r\n<p>3.用户密码字段加密；</p>\r\n<p>&nbsp;</p>\r\n<p>4.改写大量代码，优化系统结构，修正若干BUG。</p>\r\n<p>&nbsp;</p>\r\n<p>&nbsp;</p>','',NULL,'本站',0,'','2011-05-22','2011-05-18 23:34:12','','','2011年5月21日J2CMS新版本发布!','',2157,7,1,1,'2013-02-19 21:28:22'),
...
/*!40000 ALTER TABLE `j2_article` ENABLE KEYS */;


--
-- Definition of table `j2_channel`
--

DROP TABLE IF EXISTS `j2_channel`;
CREATE TABLE `j2_channel` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- Dumping data for table `j2_channel`
--

/*!40000 ALTER TABLE `j2_channel` DISABLE KEYS */;
...
/*!40000 ALTER TABLE `j2_channel` ENABLE KEYS */;


--
-- Definition of table `j2_comment`
--

DROP TABLE IF EXISTS `j2_comment`;
CREATE TABLE `j2_comment` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `content` longtext,
...
--
-- Dumping data for table `j2_comment`
--

/*!40000 ALTER TABLE `j2_comment` DISABLE KEYS */;
/*!40000 ALTER TABLE `j2_comment` ENABLE KEYS */;


--
-- Definition of table `j2_config`
--

DROP TABLE IF EXISTS `j2_config`;
CREATE TABLE `j2_config` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  ...
  `ctp` varchar(20) DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8;

--
-- Dumping data for table `j2_config`
--

/*!40000 ALTER TABLE `j2_config` DISABLE KEYS */;
...
--
-- Dumping data for table `j2_flash`
--

/*!40000 ALTER TABLE `j2_flash` DISABLE KEYS */;
INSERT INTO `j2_flash` (`id`,`image_url`,`link_url`,`title`,`check_state`,`sys_date`) VALUES 
 ...
 (5,'images/AD/java_host.jpg','/host.html','高性能JAVA虚拟主机  100元/年',2,'2013-02-19 21:21:58');
/*!40000 ALTER TABLE `j2_flash` ENABLE KEYS */;


--
-- Definition of table `j2_group`
--

DROP TABLE IF EXISTS `j2_group`;
CREATE TABLE `j2_group` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- Dumping data for table `j2_group`
--

/*!40000 ALTER TABLE `j2_group` DISABLE KEYS */;
INSERT INTO `j2_group` (`id`,`info`,`manager_article`,`manage_channel`,`manage_comment`,`manage_config`,`manage_group`,`manager_log`,`manager_user`,`name`,`check_state`,`sys_date`) VALUES 
 (1,'','N','N','N','N','N','N','N','测试用户',2,'2013-02-19 21:22:49'),
 (5,'','Y','Y','Y','Y','Y','Y','Y','系统管理员',2,NULL),
 (12,'','N','N','N','N','Y','N','Y','普通管理员',2,'2013-02-19 21:22:57');
/*!40000 ALTER TABLE `j2_group` ENABLE KEYS */;


--
-- Definition of table `j2_log`
--

DROP TABLE IF EXISTS `j2_log`;
CREATE TABLE `j2_log` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- Dumping data for table `j2_log`
--

/*!40000 ALTER TABLE `j2_log` DISABLE KEYS */;
/*!40000 ALTER TABLE `j2_log` ENABLE KEYS */;


--
-- Definition of table `j2_order`
--

DROP TABLE IF EXISTS `j2_order`;
CREATE TABLE `j2_order` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  ...
  CONSTRAINT `FKA21157652A3513` FOREIGN KEY (`channel_id`) REFERENCES `j2_channel` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

--
-- Dumping data for table `j2_order`
--

/*!40000 ALTER TABLE `j2_order` DISABLE KEYS */;
/*!40000 ALTER TABLE `j2_order` ENABLE KEYS */;


--
-- Definition of table `j2_user`
--

DROP TABLE IF EXISTS `j2_user`;
CREATE TABLE `j2_user` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- Dumping data for table `j2_user`
--

/*!40000 ALTER TABLE `j2_user` DISABLE KEYS */;
...
/*!40000 ALTER TABLE `j2_user` ENABLE KEYS */;
