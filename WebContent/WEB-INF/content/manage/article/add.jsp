...
<table width="100%" border="1" cellpadding="1">
	<tr >
        ...
        <b class="title">发布文章:${entity.id}</b>
	...
	<tr>
		...
		允许评论
		<input type="checkbox" name="entity.commentState" id="entity.commentState" value="true" checked="checked"/>
	...
	<tr>
		...
		<td colspan="2"><input name="entity.author" value="${empty entity.author?user.realName:entity.author}" type="text" id="entity.author"
