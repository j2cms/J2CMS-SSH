...
<table width="100%" border="1" cellpadding="0" cellspacing="0">
	...
	<tr>
		...
		推荐级别
		<select name="entity.recommendLevel" id="entity.recommendLevel">
		...
		允许评论
		<input type="checkbox" name="entity.commentState" id="entity.commentState" value="true" />
		<c:if test="${entity.commentState==true||entity.commentState==null}">
		  <script>document.all["entity.commentState"].checked="checked"</script>
		</c:if>
	...
	<tr>
		...
		<td colspan="2"><input name="entity.title" value="${entity.title}" type="text" id="entity.title"
			size="40" maxlength="60"/><span class="info1">&nbsp;*&nbsp;${message1}</span></td>
	</tr>
	<tr>
		<td height="25px" align="right">作者：</td>
		<td colspan="2"><input name="entity.author" value="${entity.author}" type="text" id="entity.author"
			size="40" maxlength="20"/><span class="info1">&nbsp;*&nbsp;${message2}</span></td>
	</tr>
	<tr>
		<td height="25px" align="right">发布时间：</td>
		<td colspan="2"><input name="entity.releaseDate" value="${entity.releaseDate}" type="text" id="entity.releaseDate"
			size="40" maxlength="20"/><span class="info1">&nbsp;*&nbsp;${message3}</span></td>
	</tr>
	<tr>
		<td height="25px" align="right">来源：</td>
		<td colspan="2"><input name="entity.origin" value="${entity.origin}" type="text" id="entity.origin"
			size="40" maxlength="60"/></td>
	</tr>
	<tr>
		<td height="25px" align="right">tag标签：</td>
		<td colspan="2"><input name="entity.tags" value="${entity.tags}" type="text" id="entity.tags"
    ...
    <tr>
		...
		<td colspan="2"><input type="text" name="entity.relatedID" id="entity.relatedID" value="${entity.relatedID}" size="40" /> 
		  <span class="info1"></span></td>
	</tr>    
	<tr>
		<td height="25px" align="right">摘要：</td>
		<td colspan="2"><textarea name="entity.summary"  rows="3" cols="97"
			id="entity.summary" value="${entity.summary}"></textarea> <span class="info1">小于200字</span></td>
	</tr>
	<tr>
    	<td >&nbsp;</td>
		<td colspan="2"><FCK:editor instanceName="entity.content"
