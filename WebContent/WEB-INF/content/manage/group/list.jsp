			...
			<div id="main_column">
				...
				<div>
					<div class="mainbox-title-container">
						<div class="mainbox-title">用户组管理</div>
					</div>
								...
								<td>
									<div class="statistics-box-order">
										<div class="statistics-body-order">
											...
											<table width="100%">
												<tr>
													<td align="left"><input type="button" onClick="add()" value=" 增 加 " />&nbsp;&nbsp; <input type="button" onClick="edit()" value=" 修 改 " />&nbsp;&nbsp; <input type="button" onClick="del()" value=" 删 除 " />&nbsp;&nbsp;</td>
												</tr>
											</table>
