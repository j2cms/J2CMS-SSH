...
<table width="100%" border="1" cellpadding="1">
	<tr >
        ...
        <b class="title">发布文章:${article.id}</b>
        ...
        <input name="article.user.id" type="hidden" id="article.user.id" value="${user.id}"/>
	...
	<tr>
        ...
        <script>
		   document.getElementById("article.channel.id").value ='${selector.channel.id>1?selector.channel.id:1}';
		</script>
		&nbsp;允许浏览用户组
		...
		允许评论
		<input type="checkbox" name="article.commentState" id="article.commentState" value="true" checked="checked"/>
	...
	<tr>
		...
		<td colspan="2"><input name="article.author" value="${user.realName}" type="text" id="article.author"
