			...
			<div id="main_column">
				...
				<div>
					<div class="mainbox-title-container">
						<div class="mainbox-title">增加FLASH图片</div>
					</div>
					...
					<div class="mainbox-body">
						<table cellpadding="0" cellspacing="0" border="0" class="table-fixed">
							...
							<tr>
								...
								<td colspan="2"><input name="entity.title" value="" type="text" id="entity.title" size="40" maxlength="50" /></td>
							</tr>
							<tr>
								<td height="25px" align="right">图片地址：</td>
								<td colspan="2"><input name="entity.imageURL" value="" type="text" id="entity.imageURL" size="40" maxlength="300" /></td>
							</tr>
							<tr>
								<td height="25px" align="right">链接地址：</td>
								<td colspan="2"><input name="entity.linkURL" value="http://" type="text" id="entity.linkURL" size="40" maxlength="300" /></td>
							</tr>
							<tr>
								<td></td>
								<td colspan="2" height="50px"><input type="button" value=" 保 存 " onClick="javascript:checkForm()" /> <input type="button" value=" 返 回 " onclick='javascript:back()' /></td>
							</tr>
						</table>
					</div>
				</div>
