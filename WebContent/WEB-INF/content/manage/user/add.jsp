											...
											<table width="100%" border="0px;" cellpadding="0px;" cellspacing="2px;">
												...
												<tr>
													...
													<td colspan="2"><select name="entity.group.id" id="entity.group.id">
														...
														document
																.getElementById("entity.group.id").value = '${selector.group.id>1?selector.group.id:1}';
												...
												<tr>
													...
													<td colspan="2"><input name="entity.password" type="password" id="entity.password" value="${entity.password}" /> <span class="info1">&nbsp;*&nbsp;${message2}</span></td>
												</tr>
												<!--  
	<tr>
